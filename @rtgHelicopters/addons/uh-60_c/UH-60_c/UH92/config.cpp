...
class CfgPatches
{
	class Ej_UH92
	{
		units[] = {"ej_UH92_MEV","ej_UH92","ej_UH92_NATO","ej_UH92_RWG","ej_MH92DAP2","ej_MH92DAP","ej_MH92"};
		weapons[] = {};
		magazines[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	class ej_MH92DAP2: ej_MH92
	{
		...
		crew = "160th_SOAR_Pilot";
		typicalCargo[] = {"160th_SOAR_Pilot"};
		displayName = "MH-92F DAP (M230/3 pylons)";
		model = "\UH-60\MH92\ej_MH92DAP2.p3d";
		irtarget = 1;
		transportSoldier = 0;
		...
		weapons[] = {"ej_master_arms_safe","EricJ_CMFlareLauncher","M230","kuy_IR_Jammer_Weapon","missiles_DAGR"};
