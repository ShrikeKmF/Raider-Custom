class CfgPatches
{
	class rtgVehicles
	{
		...
		author = "Shrike";
		url = "";
		requiredAddons[] = {"a3_characters_F","a3_characters_F_beta","A3_Characters_F_Common","a3_characters_f_beta","a3_characters_f_gamma","A3_Soft_F_epc"};
		units[] = {
			// Base
				"rtg_BasicSupply",
				"rtg_wheelsBox",
