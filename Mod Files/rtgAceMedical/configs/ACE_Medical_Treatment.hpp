class ace_medical_treatment {
    class Bandaging {
        // packing bandage is highest treatment, higher reopen change, short reopening delay
        // elastic bandage is average treatment, average reopen change, average reopen delay
