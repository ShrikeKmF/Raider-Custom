class ACEAX_CTRG_Uniforms
{
    ...
    class variant
    {
        ...
        class G3Field_Full { label = "G3Field Full"; description = "Full G3Field uniform"; };
        class G3Field_Half { label = "G3Field Half"; description = "Half G3Field uniform"; };
        class G3Field_S { label = "G3Field S"; description = "Short G3Field variant"; };
        class G3Field_Full_Roll { label = "G3Field Full Roll"; description = "Full G3Field with rolled sleeves"; };
        class G3Field_Half_Roll { label = "G3Field Half Roll"; description = "Half G3Field with rolled sleeves"; };
        class G3Field_S_Roll { label = "G3Field S Roll"; description = "Short G3Field with rolled sleeves"; };
        class PCU_Full { label = "PCU Full"; description = "Full PCU uniform"; };
        class CCTRG_PCU_Half { label = "CCTRG PCU Half"; description = "Half PCU uniform"; };
